...
When returning to the host, if /mnt/lfs/dev, /mnt/lfs/sys, /mnt/lfs/proc, /mnt/lfs/run succeeds in unmounting, you can ignore the warning about output when exiting the chroot environment. 
